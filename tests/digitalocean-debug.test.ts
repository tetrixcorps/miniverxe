...
test.describe('DigitalOcean App URL Debug Test', () => {
  test('should debug Client Login button on DigitalOcean app URL', async ({ page }) => {
    console.log('🌐 Testing DigitalOcean app URL: https://tetrix-minimal-uzzxn.ondigitalocean.app');
    ...
    // Navigate to DigitalOcean app URL
    ...
    console.log('✅ Client Login button found on DigitalOcean app URL');
    ...
    await page.screenshot({ path: 'test-results/digitalocean-debug.png' });
    console.log('📸 Screenshot saved to test-results/digitalocean-debug.png');
  });
});

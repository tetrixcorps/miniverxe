...
const validateGDPRCompliance = (data: any) => {
  ...
  const gdprChecks = {
    consentObtained: data.hasConsent,
    dataMinimization: data.collectsMinimalData,
    rightToErasure: data.supportsDataDeletion,
    dataPortability: data.supportsDataExport,
    breachNotification: data.hasBreachNotification,
    privacyByDesign: data.privacyByDesign
  };
...
const validateCCPACompliance = (data: any) => {
  ...
  const ccpaChecks = {
    noticeAtCollection: data.hasNoticeAtCollection,
    rightToKnow: data.supportsDataAccess,
    rightToDelete: data.supportsDataDeletion,
    rightToOptOut: data.supportsOptOut,
    nonDiscrimination: data.nonDiscriminatory,
    dataCategories: data.disclosesDataCategories
  };
...
const validateTelecomCompliance = (data: any) => {
  ...
  const telecomChecks = {
    callRecordingConsent: data.hasRecordingConsent,
    doNotCallRegistry: data.checksDoNotCallRegistry,
    callerId: data.providesCallerId,
    callDisclosure: data.disclosesCallPurpose,
    optOutMechanism: data.providesOptOut,
    callTimeRestrictions: data.respectsTimeRestrictions
  };

...
const ProjectAnalytics: React.FC = () => {
  ...
  const { data, isLoading, error } = useQuery({
    ...
    queryFn: () => projectId ? apiService.getProjectAnalytics(projectId) : Promise.resolve({ data: null }),
    enabled: !!projectId,
  });
  ...
  return (
    <div className="p-8">
      ...
      <p className="mb-4">Analytics and metrics for this project.</p>
      {isLoading ? (
        ...
        <>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            <div className="bg-white p-4 rounded-lg shadow">
              ...
              <div className="text-2xl font-bold">{data.data.totalTasks}</div>
            </div>
            <div className="bg-white p-4 rounded-lg shadow">

...
export const SalesforceWidget: React.FC = () => {
  ...
  const handleConnect = () => {
    ...
    window.open('/api/integrations/salesforce/connect', '_blank');
  };
      ...
      {connected ? (
        <div className="space-y-4">
          <div className="grid grid-cols-3 gap-4">
            ...
            <div className="text-center">
              <p className="text-2xl font-bold text-gray-900">{data.opportunities}</p>
        ...
        <div className="text-center py-4">
          <p className="text-sm text-gray-600 mb-4">
            Connect your Salesforce account to sync leads, opportunities, and revenue data.
          </p>
          <button

// Clio Cases API Endpoint
// Fetches cases from Clio API using OAuth tokens
...
export const GET: APIRoute = async ({ request }) => {
  try {
    ...
    console.error('Clio cases API error:', error);
    
    return new Response(
      JSON.stringify({
        error: 'Failed to fetch Clio cases',

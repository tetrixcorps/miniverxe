...
# TETRIX Final Malformed Entity Fix
# This script fixes all malformed HTML entities across all files
...
echo -e "${BLUE}🔧 TETRIX Final Malformed Entity Fix${NC}"
echo "=============================================="

# Function to fix malformed entities in a file
...
# Find all files with malformed entities
echo -e "${YELLOW}Finding files with malformed entities...${NC}"
files_to_fix=($(find src/pages -name "*.astro" -exec grep -l "📈#128200;\|⚙️#9881;\|🔧#128295;\|🌐#127760;\|🚀#128640;\|💡#128161;\|🔒#128274;\|🛡️#128737;\|⚡#9889;\|📊#128202;\|💰#128176;\|🤖#129302;\|🧠#129504;\|🏥#127973;\|🏦#127976;\|🛒#128722;\|📱#128241;\|📞#128222;\|💬#128172;\|🎤#127908;\|☎️#9742;\|🔐#128272;\|📲#128242;\|🏷️#127991;\|💼#128188;\|🏭#127981;\|🔗#128279;\|✍️#9997;\|📝#128221;\|↻#8635;\|🚛#128739;\|📡#128225;\|💳#128179;\|🔌#128224;\|🏠#127968;\|🏢#127970;\|☁️#9729;" {} \;))

if [ ${#files_to_fix[@]} -eq 0 ]; then
    echo -e "${GREEN}No files found with malformed entities.${NC}"
    exit 0
fi
...
echo ""
echo -e "${GREEN}🎉 Malformed entity fixes completed!${NC}"
